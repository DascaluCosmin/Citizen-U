...
class GetReportedIncident @Inject constructor(
    private val citizenRequestRepository: CitizenRequestRepository,
) {

    suspend operator fun invoke(citizenId: String, incidentId: String) =
        citizenRequestRepository.getIncident(citizenId, incidentId)
}
